...
/**
 * Classe que contém os métodos úteis relacionados ao CPF e CNPJ
 * (Validação e geração)
 * 
...
public class CPFCNPJUtils {
	...
	/**
	 * @param comPontuacao booleano que diz se o CPF retornado conterá as pontuação no formato xxx.xxx.xxx-xx
	 * @return um CPF válido gerado aleatóriamente
	 */
	...
	/**
	 * @param comPontuacao booleano que diz se o CNPJ retornado conterá as pontuação no formato xx.xxx.xxx/xxxx-xx
	 * @return um CNPJ válido gerado aleatóriamente
	 */
	...
	/**
	 * @param cpf
	 * @return boolean que indica se o CPF é válido
	 */
	public static boolean isCPFValido(String cpf) {
		...
		// Testa os CPFS que são válidos, porém devem ser barrados
	...
	/**
	 * @param cnpj
	 * @return boolean que indica se o CNPJ é válido
	 */
	...
	/**
	 * @param cpf
	 * @return boolean que indica se o primeiro dígito do CPF é válido
	 */
	...
	/**
	 * @param cpf
	 * @return boolean que indica se o segundo dígito do CPF é válido
	 */
	...
	/**
	 * @param cpf, podendo ser apenas os primeiros 9 dígitos do CPF, sem os validadores
	 * @return primeiro dígito validador do cpf baseasdo nos 9 dígitos
	 */
	...
	/**
	 * @param cpf, podendo ser apenas os primeiros 10 dígitos do CPF, apenas com o primeiro dígito validador, sem o segundo
	 * @return segundo dígito validador do cpf baseasdo nos 10 dígitos
	 */
	...
	/**
	 * @param cnpj
	 * @return boolean que indica se o primeiro dígito do CNPJ é válido
	 */
	...
	/**
	 * @param cnpj
	 * @return boolean que indica se o segundo dígito do CNPJ é válido
	 */
	...
	/**
	 * @param cnpj, podendo ser apenas os primeiros 12 dígitos do CNPJ, sem os validadores
	 * @return primeiro dígito validador do cpf baseasdo nos 12 dígitos
	 */
	...
	/**
	 * @param cnpj, podendo ser apenas os primeiros 12 dígitos do CNPJ, mais o primeiro digito validador, sem o ultimo
	 * @return primeiro dígito validador do cpf baseasdo nos 13 dígitos
	 */
	...
	/**
	 * @param str
	 * @return a mesma string, porém apenas com os dígitos
	 */
